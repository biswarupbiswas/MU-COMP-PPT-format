...
% Optional: Customize theme and colortheme here if desired (e.g., \usetheme{Madrid})
% If none specified, the default Pittsburgh theme with beaver colortheme is loaded.
\usepackage{mucomp}
...
\institute{Department of Mathematics, Mahindra University}
