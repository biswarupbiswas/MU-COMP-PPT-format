...
\begin{frame}{Embedded Video: WENO Simulation}
  \begin{columns}
    ...
    \begin{column}{0.55\textwidth}
      \centering
      % Usage: \embedmpfour[options]{placeholder_text_or_graphic}{video_file}
      \embedmpfour[width=\textwidth,height=0.6\textheight]{%
        \includegraphics[width=\textwidth,height=0.6\textheight]{RP2D1_frames/frame_0001.png}%
      }{KPP_2D_WENO.mp4}
