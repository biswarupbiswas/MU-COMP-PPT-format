...
\setlength{\videowidth}{\dimexpr 0.6\textheight - 20pt\relax}
\begin{frame}{Embedded Video: WENO Simulation}
  \begin{columns}
    ...
    \begin{column}{0.55\textwidth}
      \centering
      % Compensate for the 20pt controls bar to get a perfect square video aspect ratio
      \embedmpfour[width=\videowidth,height=0.6\textheight]{%
        \includegraphics[width=\videowidth,height=\videowidth]{RP2D1_frames/frame_0001.png}%
      }{KPP_2D_WENO.mp4}
